...
package com.reactnative.paypalsdk;
...
import com.reactnative.paypalsdk.utils.BundleJSONConverter;
...
public class RNPaypalSdkModule extends ReactContextBaseJavaModule {
  ...
  public RNPaypalSdkModule(ReactApplicationContext reactContext) {
    super(reactContext);
